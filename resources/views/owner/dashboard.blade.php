...
@section('title', 'Dashboard Owner - Yujin Foto Studio')
        ...
        <div class="card border-0 shadow-sm bg-gradient-primary text-white">
            <div class="card-body py-4">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h3 class="mb-1">Selamat Datang di Dashboard Owner</h3>
    ...
    <div class="card-body p-4">
        ...
        @if($recentBookings->count() > 0)
            <div class="text-center mt-4">
                <a href="{{ route('owner.business-intelligence') }}" class="btn btn-outline-primary">
                    <i class="bi bi-eye me-1"></i> Lihat Analisis Lengkap
                </a>
            </div>
        @endif
    </div>
