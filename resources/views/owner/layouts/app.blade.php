...
<head>
    ...
    <title>@yield('title', 'Owner Dashboard') - {{ config('app.name', 'Yujin Foto Studio') }}</title>
    ...
    <style>
        ...
        .sidebar {
            ...
            box-shadow: 4px 0 25px rgba(0, 0, 0, 0.15), 0 0 50px rgba(102, 126, 234, 0.1);
        ...
        .top-nav::before {
            ...
            right: 0;
            height: 3px;
            background: linear-gradient(90deg, #667eea 0%, #764ba2 25%, #4facfe 50%, #00f2fe 75%, #667eea 100%);
        ...
        .top-nav .user-info {
            background: linear-gradient(135deg, rgba(102, 126, 234, 0.1) 0%, rgba(75, 192, 254, 0.1) 100%);
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar">
                <div class="position-sticky pt-3">
                    <div class="sidebar-header">
                        ...
                        <small class="text-white-50">Owner Panel</small>
                    </div>
                    ...
                    <div class="nav-section">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('owner.business-intelligence*') ? 'active' : '' }}" 
                                   href="{{ route('owner.business-intelligence') }}">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-4 pb-3 mb-4 top-nav px-4">
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                            <h1 class="h2 mb-0 text-primary fw-bold">@yield('page-title', 'Dashboard Owner')</h1>
                            <small class="text-muted">@yield('page-subtitle', 'Selamat datang di panel owner')</small>
                        </div>
                    </div>
